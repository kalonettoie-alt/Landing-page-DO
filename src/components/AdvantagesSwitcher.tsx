...
export default function AdvantagesSwitcher() {
  ...
  return (
    <section className="py-20 bg-[#0F3D2E] rounded-[2rem] md:rounded-[3rem] mx-4 md:mx-8 lg:mx-16 my-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-[#C9A962] italic text-center text-lg md:text-xl mb-16 max-w-4xl mx-auto">
