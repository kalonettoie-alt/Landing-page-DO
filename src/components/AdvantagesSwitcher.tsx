    ...
    <section className="py-20 bg-deltom-green">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-deltom-copper italic text-center text-lg md:text-xl mb-16 max-w-4xl mx-auto">
          ...
          <AnimatePresence mode="wait">
            ...
            >
              {currentAdvantages.map((advantage, index) => (
                ...
                >
                  <advantage.icon className="w-12 h-12 text-deltom-copper mb-4" />
                  <h3 className="font-bold text-xl text-deltom-green mb-2">
                    {advantage.title}
                  </h3>
                  <p className="font-semibold text-deltom-copper mb-3">
                    {advantage.subtitle}
                  </p>
                  <p className="text-deltom-gray">
